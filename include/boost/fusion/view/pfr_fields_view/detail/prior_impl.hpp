...
#if !defined(BOOST_FUSION_PFR_FIELDS_VIEW_PRIOR_IMPL_HPP_INCLUDED)
#define BOOST_FUSION_PFR_FIELDS_VIEW_PRIOR_IMPL_HPP_INCLUDED
...
namespace boost { namespace fusion {
    ...
    namespace extension
    {
        ...
        template<>
        struct prior_impl<pfr_fields_view_iterator_tag>
        {
